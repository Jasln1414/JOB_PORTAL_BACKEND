...
urlpatterns = [
    ...
    path('savejob/<int:job_id>/', SavejobStatus.as_view(), name='save-job'),  
    path('check-saved/<int:job_id>/', CheckJobSaveStatus.as_view(), name='check-saved'),  
    path('savedjobs/', SavedJobsView.as_view(), name='saved-jobs'), 
